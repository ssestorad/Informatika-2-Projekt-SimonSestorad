...
class CalculateScoreTests(unittest.TestCase):
    ...
    def test_triple_two(self):
        self.assertEqual(score_of([2, 2, 2]), (200, [("triple", 2, 200)]))

    def test_triple_three(self):
        self.assertEqual(score_of([3, 3, 3]), (300, [("triple", 3, 300)]))

    def test_triple_four(self):
        self.assertEqual(score_of([4, 4, 4]), (400, [("triple", 4, 400)]))

    def test_triple_five(self):
        self.assertEqual(score_of([5, 5, 5]), (500, [("triple", 5, 500)]))

    def test_triple_six(self):
        self.assertEqual(score_of([6, 6, 6]), (600, [("triple", 6, 600)]))

    def test_triple_one(self):
        self.assertEqual(score_of([1, 1, 1]), (1000, [("triple", 1, 1000)]))

    def test_straight(self):
        self.assertEqual(score_of([1, 2, 3, 4, 5, 6]), (2000, [("straight", 2000)]))

    def test_six_of_a_kind(self):
        self.assertEqual(score_of([3, 3, 3, 3, 3, 3]), (5000, [("six_kind", 5000)]))

    def test_three_pairs(self):
        self.assertEqual(score_of([2, 2, 3, 3, 4, 4]), (1000, [("three_pairs", 1000)]))
    ...
    def test_four_of_a_kind_plus_pair_is_not_three_pairs(self):
        ...
        self.assertEqual(combos, [("triple", 1, 1000)])
